...
class DemoDataset(DatasetTemplate):
    def __init__(self, dataset_cfg, class_names, training=True, root_path=None, logger=None, ext='.npy'):
        ...
        self.sample_file_list = sorted(
            [os.path.join(root_path, f"points_test/{frame_id}{ext}") for frame_id in test_frame_ids]
        )
...
def parse_config():
    ...
    args.cfg_file = "cfgs/custom_av/dsvt_voxel.yaml"
    args.ckpt = "../output/custom_av/dsvt_voxel/default/ckpt/checkpoint_epoch_1.pth"
